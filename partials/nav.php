...
<style> @import url('https://fonts.googleapis.com/css2?family=Zilla+Slab:wght@300&display=swap'); </style>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <?php if (has_role("Admin")) : ?>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark bg-dark bg-gradient" aria-labelledby="rolesDropdown">
                            ...
                            <li><a class="dropdown-item" href="<?php echo get_url('admin/search.php'); ?>">Search</a></li>
                            <li><a class="dropdown-item" href="<?php echo get_url('admin/manage.php'); ?>">Manage Accounts</a></li>
                        </ul>
                    </li>
                <?php endif; ?>
                <?php if (is_logged_in()) : ?>
